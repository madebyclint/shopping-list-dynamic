...
- Eggplant (2 medium) — Pinakbet — ~$2.00 ea — **~$4.00**
- Okra (½ lb) — Pinakbet — ~$3.00/lb — **~$1.50**
- Chayote (2) — Pinakbet — ~$1.50 ea — **~$3.00**
- Butternut squash (1 small, ~2 lbs) — Pinakbet — ~$2.99 — **~$2.99**
- Green beans (½ lb) — Pinakbet — ~$2.99/lb — **~$1.50**
- Tomatoes, plum (6) — Pinakbet + Sopa de Lima + Burgers — ~$1.79/lb — **~$3.58** (~2 lbs)
- Yellow onions (3 large) — Pinakbet + Sopa de Lima + Turkey Pasta + Burgers — ~$1.19/lb — **~$3.57**
- Jalapeños (2) — Sopa de Lima — ~$0.50 ea — **~$1.00**
- Green onions (3 bunches) — Arroz Caldo (whites for cooking + greens for garnish) — $1.50 ea — **~$4.50**
- Fresh ginger, extra large piece (~6 oz) — Arroz Caldo brunch (need a lot) + Pinakbet — ~$2.70 *(pantry staple but buy extra for brunch)* — **~$2.70**
- Cilantro (1 bunch) — Sopa de Lima + Esquites — $0.99 — **$0.99**
- Salad mix or head of lettuce (1) — Burgers + Turkey Pasta salad — ~$2.99 — **~$2.99**

**— Fruit —**

- Limes (6) — Sopa de Lima (4) + Esquites (2) — ~$0.75 ea — **~$4.50**
- Watermelon (1 small seedless) — Hamburgers side — ~$5.99 — **~$5.99**
- Pineapple (1) — Sopa de Lima side — $3.79 — **$3.79**
...
- Rotisserie chicken (1 large, shredded) — Arroz Caldo brunch — ~$11.99 — **~$11.99**
  *(Ideal Foods hot bar or any supermarket)*
- Beef stew chunks (~1.5 lbs) — Pinakbet — ~$8.00/lb est — **~$12.00**
  *(Ask butcher at Ideal Foods; or buy eye round and cube at home. Brooklyn Fare also an option.)*
- Pre-made beef burger patties (1 pack, 4–6 ct) — Hamburgers — ~$7.99 — **~$7.99**
- Ground turkey (1 lb) — Turkey Pasta Skillet — ~$5.99 — **~$5.99**
- Uncured beef hot dogs (1 pack, 8 ct) — Esquites — ~$5.99 — **~$5.99**

Proteins Subtotal: **~$43.96**
...
- Fried garlic, store-bought (1 small jar or bag) — Arroz Caldo garnish — ~$2.99 — **~$2.99** *(Asian/condiment aisle)*
...
- Salt & vinegar chips (1 bag) — Arroz Caldo garnish + snacking — ~$3.79 — **~$3.79**
- Tortilla chips (1 bag) — Sopa de Lima (crushed strips) + snacking — ~$3.79 — **~$3.79**
- Cereal (2 boxes) — ~$5.00 ea — **~$10.00**
- Almond Breeze original (1 gallon) — ~$10.00 — **~$10.00**
- Lactaid Whole Milk (½ gallon) — $6.19 — **$6.19**
...
**— Produce —**
- Eggplant (2 medium) — Pinakbet
- Okra (½ lb) — Pinakbet
- Chayote (2) — Pinakbet
- Butternut squash (1 small) — Pinakbet
- Green beans (½ lb) — Pinakbet
- Tomatoes, plum (6) — Pinakbet + Sopa de Lima + Burgers
- Yellow onions (3 large) — all week
- Jalapeños (2) — Sopa de Lima
- Cilantro (1 bunch) — Sopa de Lima + Esquites
- Salad mix or head of lettuce (1) — Burgers + Turkey Pasta
- Limes (6) — Sopa de Lima + Esquites
- Watermelon (1 small seedless) — Hamburgers side
- Pineapple (1) — Sopa de Lima side
...
**— Proteins —**
- Rotisserie chicken (1 large) — Arroz Caldo brunch
- Beef stew chunks (~1.5 lbs) — ask butcher *(or buy eye round and cube at home)*
- Pre-made beef burger patties (1 pack)
- Ground turkey (1 lb)
- Uncured beef hot dogs (1 pack)
...
- Fried garlic, store-bought (1 jar/bag) — Arroz Caldo garnish *(Asian/condiment aisle)*
- Peanuts, roasted (1 bag) — Arroz Caldo garnish
- Kecap manis (1 bottle) — Arroz Caldo garnish *(1426 St Johns or Brooklyn Fare)*

**— Weekly Staples —**
- Salt & vinegar chips (1 bag) — Arroz Caldo garnish + snacking
- Tortilla chips (1 bag) — Sopa de Lima (crushed strips) + snacking
- Cereal (2 boxes)
- Almond Breeze (1 gallon)
