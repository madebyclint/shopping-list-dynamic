# Shopping List — Sat Mar 21 to Fri Mar 27, 2026 — ~$259

> **Note:** Saturday and Sunday are carryover meals, so no new grocery items are included for Lomo Saltado or Maafe. Lox + bagels + decaf coffee should be bought at Brooklyn Fare. Without protein powder: ~$217.
...
*(none this week — using carryover meals, no new specialty items needed)*

Specialty Subtotal: **$0**

---

🧻 **OTHER**

- Protein powder (1 container) — extra — 1 ea — $43.00 — **$43.00** (St Johns Market)
- Toilet paper (1 pack) — pantry/weekly — 1 pack — ~$10.49 — **$10.49**
- Paper towels (1 pack) — pantry/weekly — 1 pack — ~$9.99 — **$9.99**

Other Subtotal: **~$63.48**

---

**Total: ~$259.43**

*(Subtract $43 if picking up protein powder separately → ~$217)*
...
### Brooklyn Fare
*(Specialty, fresh deli, quality lox — do this trip first)*
- Smoked salmon / lox (~12–16 oz total) *(refrigerated section or deli case)*
- Bagels (1 pack, 6 ct)
- Decaf coffee (1 lb bag, ~$16)
- Fresh dill (1 bunch) *(check markdown rack; reg ~$3.49)*
- Check markdown rack for produce deals (dill, onions, etc.)
...
**Other**
- Protein powder ($43) (St Johns Market)
- Toilet paper (1 pack)
- Paper towels (1 pack)

---

### 1426 St Johns / Utica Ave African Market
*(No stop needed this week unless you want extras)*
