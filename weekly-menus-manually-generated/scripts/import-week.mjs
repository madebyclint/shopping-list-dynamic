...
const menuMd       = readFileSync(path.join(WEEKLY_DIR, 'menus', '2026-06-15-menu.md'), 'utf8');
const shoppingMd   = readFileSync(path.join(WEEKLY_DIR, 'shopping-lists', '2026-06-15-shopping-list.md'), 'utf8');
...
const WEEK_DATE = '2026-06-15';
const LABEL     = 'Week of Jun 15, 2026';
...
async function run() {
  ...
  try {
    ...
    console.log('\n✅ All done — week 2026-06-15 is live in the DB.');
  } catch (err) {
